...
/**
 * <p>
 * Wraps a <code>ResultSet</code> in an <code>Iterator<Object[]></code>. This is
 * useful when you want to present a non-database application layer with domain
 * neutral data.
 * </p>
 *
 * <p>
...
public class ResultSetIterator implements Iterator<Object[]> {
	...
	public boolean hasNext() {
		try {
			...
			rethrow(e);// 重新定义了异常，这种方式根本就没有返回值的，调用者不用处理，但是起到了提示的作用，好方法。
			return false;
		}
	}
